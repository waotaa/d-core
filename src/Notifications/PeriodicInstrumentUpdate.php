...
namespace Vng\DennisCore\Notifications;
...
class PeriodicInstrumentUpdate extends Notification
{
    ...
    public function buildMailMessage($notifiable)
    {
        ...
        $mailMessage->line(__('This e-mail is a reminder to view the instruments and update them where necessary. In this way Dennis remains current.'));
        ...
        $mailMessage->line('Instrumentengids Dennis');
        return $mailMessage;
    }
    ...
    {
        $message = $message->line(__('The following instruments have been added to the Dennis instrument guide for quite some time.'));
